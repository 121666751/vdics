...
protected:
	 ...
	 *
	 * @param multipart document to attach to.
	 * @param Content-Type to use.
	 */
...
public:
	 ...
	 *
	 * @param output to stream to.
	 */
	void head(std::ostream *out);
	 ...
	 *
	 * @param multipart form this is part of
	 * @param name of form data field
	 * @param value of form data field
	 */
