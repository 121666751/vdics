...
class CGridCtrl;
ZPYEXT_API void AFXAPI DDX_GridControl(CDataExchange* pDX, int nIDC, CGridCtrl& rControl);

/////////////////////////////////////////////////////////////////////////////
// CGridCtrl window

class ZPYEXT_API CGridCtrl : public CWnd
{
// Construction
public:
    ...
    BOOL SubclassWindowEx(HWND hWnd);
