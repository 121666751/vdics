...
#ifndef	CCXX_SERIAL_H_
#define	CCXX_SERIAL_H_
...
#endif
class CCXX_CLASS_EXPORT TTYStream : protected std::streambuf, public std::iostream, public Serial
{
private:
	int doallocate();
...
class CCXX_CLASS_EXPORT ttystream : public TTYStream
{
public:
	/**
...
class CCXX_CLASS_EXPORT TTYSession : public TTYStream, public Thread
{
public:
	/**
