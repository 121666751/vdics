...
public:
	...
	VHTMLStream(	VWebServerRequest*	pWebServerRequest =
											NULL,
	...
	void				Char(VCHAR nChar)
	{
		VCHAR sz[2] = {nChar, VTEXT('\0')};
		Stream(sz);
	}
	...
	void				HREF(	VSTRING_CONST pszURL,
								VSTRING_CONST pszDisplayName =
												NULL,
								VSTRING_CONST pszTargetFrame =
												NULL,
								VSTRING_CONST pszProtocol =
												NULL)
	{
