...
public:
	 ...
	 *
	 * @param page size for allocation
	 */
...
public:
	 ...
	 * @param key value set to parse, or NULL to parse from head
	 * @param optional key prefix
	 */
...
public:
	 ...
	 *
	 * @param limit before wait queuing.
	 */
